package com.androidapp.pocketRto.Cards;
...
import com.androidapp.pocketRto.Activities.LicenseActivity;
...
public class AboutCard extends Card
{
    ...
    public void setupInnerViewElements(ViewGroup parent, View view)
    {
        ...
        switch (type)
        {
            ...
            case 5:
            {
                ((TextView)parent.findViewById(R.id.build_version)).setText(MainActivity.versionName);
                ((TextView)parent.findViewById(R.id.database_version)).setText(Integer.toString(DataBaseHandler.DATABASE_VERSION)) ;
                break;
            }
        }
    }
